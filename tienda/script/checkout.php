...
try {
    ...
    if ($_SESSION['envio'] == 'recojo' || $_SESSION['solo_gift_cards'] == 'true') {
        $pedidoInsertado = $objPedido->addPedido($customerID,
            ...
            $lastFour, $card_number, $horaPedido, $brand, $saldoBilletera, 1, 'false', $local_distrito, '-', '-', $_SESSION['current_customer_tipoDocumento'],
            $razonSocial, $direccionFiscal, $ruc, $latitud, $longitud, 0);

    } else {

         $pedidoInsertado = $objPedido->addPedido($customerID,
            $direccion, $telefono, $observaciones, $totalPipe, $puntosGanados,
            $lastFour, $card_number, $horaPedido, $brand, $saldoBilletera, $horarioPedido, 'true', $local_distrito, $referencia, $distrito, $_SESSION['current_customer_tipoDocumento'],
            $razonSocial, $direccionFiscal, $ruc, $latitud, $longitud, $_SESSION['finalShippingCost']);

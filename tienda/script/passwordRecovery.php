...
if (isset($_POST['lostEmail'])) {
    ...
    if ($cliente['cuentaConfigurada'] == 'false') {
        ...
        $urlConfigACcount = 'https://senshi.pe/tienda/r.php?c=' . $cliente['configAccountToken'] . '&id=' . $cliente['idCliente'];
    ...
    if ($addedToken > 0) {
        ...
        $url = 'https://senshi.pe/tienda/reset.php?mail=' . $lostEmail . '&tkn=' . $token;

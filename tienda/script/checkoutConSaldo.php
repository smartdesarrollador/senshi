...
$costoEnvio = $_SESSION['finalShippingCost'];
...
$firstTotal = $cart->total() + $_SESSION['finalShippingCost'];
$saldoADescontar = $cart->total() + $_SESSION['finalShippingCost'];
...
if ($_SESSION['envio'] == 'recojo' || $_SESSION['solo_gift_cards'] == 'true') {
    $pedidoInsertado = $objPedido->addPedido($customerID,
        '-', $telefono, $observaciones, 0, $puntosGanados,
        '', '', $horaPedido, '', $totalPipe, 1, 'false', '-', '-', $_SESSION['current_customer_tipoDocumento'], $razonSocial, $direccionFiscal, $ruc, $latitud, $longitud, 0);
} else {
    $pedidoInsertado = $objPedido->addPedido($customerID,
        $direccion, $telefono, $observaciones, 0, $puntosGanados,
        '', '', $horaPedido, '', $totalPipe, $horarioPedido, 'true', $referencia, $distrito, $_SESSION['current_customer_tipoDocumento'], $razonSocial, $direccionFiscal, $ruc, $latitud, $longitud, $_SESSION['finalShippingCost']);
}
$multiquery = '';
$agregarPuntos = 0;
$itemsHtml = '';
        ...
        <div style="max-width:600px;margin:0 auto">
            <div style="background:#fff;font:14px sans-serif;color:#686f7a;border-top:4px solid #9C0001;margin-bottom:20px">
                ...
                <div style="border-bottom:1px solid #f2f3f5;padding:20px 30px">
                    ...
                    <img id="m_7479378229902740556logo" width="150" style="max-width:99px;display:block" src="https://senshi.pe/tienda/img/logo2.png" alt="Logo Senshi" class="CToWUd">
        ...
        <span style="display:block;font-size:16px;font-weight:bold">
            ...
            ¡' . $_SESSION['current_customer_nombre'] . ' te ha enviado un regalo!
                        ...
                        <div style="background:#fff;font-size:16px;padding:15px">
                            <img style="max-width:100%" src="https://senshi.pe/tienda/img/carta/platos/' . $item['imagenProducto'] . '" class="CToWUd a6T" tabindex="0">
                        ...
                        <div style="background:#fff;padding:10px">
                            <div>
                                <a  style="padding:10px 15px;background:#ec5252;display:inline-block;border-radius:2px;color:#fff;font-weight:bold;font-size:17px;text-decoration:none" href="https://senshi.pe/tienda/" target="_blank" >
                            ...
                            <div style="background:#fff;font-size:12px">
                                Ve a <a href="https://senshi.pe/tienda/">https://senshi.pe</a>
                            </div>
                        </div>
            ...
            $urlConfigACcount = 'https://senshi.pe/tienda/r.php?c=' . $configAccountToken . '&id=' . $idDestinatario;
                            ...
                            <tr>
                                <td>
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="left"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td align="left"><img src="https://senshi.pe/tienda/img/logo2.png" width="100"

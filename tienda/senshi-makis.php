...
<div class="container">
    ...
    foreach ($lista as $campo) {
        $radioName = uniqid();
        if (strlen($campo['mediaPorcion']) > 0) {
            ...
            <div class="row pt-2 pb-3 py-md-4">
                ...
                <div class="col-12 col-md-6 col-lg-3 col-xl-3 d-flex align-items-center justify-content-center">
                    <div class="my-2">
                        <input class="idMediaPorcion" type="hidden" name="idMediaPorcion"
                               value="<?php echo $campo['mediaPorcion'] ?>">
                        <div class="row mb-5">
                            <div class="col text-center d-flex flex-column " >
                                ...
                                <div class=" m-0 p-0">
                                    <input name="<?php echo $radioName ?>"
                                           style="transform: scale(1.5);"
                                           class=" m-0 p-0 radioMedioMaki" type="radio">
                            ...
                            <div class="col text-center d-flex flex-column " >
                                ...
                                <div class=" m-0 p-0">
                                    <input name="<?php echo $radioName ?>"
                                           style="transform: scale(1.5);" class="t m-0 p-0"
                                           type="radio" checked>
                                </div>

                ...
                <div class="row pt-2 pb-3 py-md-4">
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 d-flex justify-content-center align-items-center">
                        <div class="text-center">
                            ...
                            <input class="productoVariacion" type="hidden" name="productoVariacion"
                                   value="<?php echo $campo['productoVariacion'] ?>">
                    ...
                    S/. <?php echo $campo['precioProducto'] ?>.00
                        ...
                        <?php } else { ?>
                            <div class="custom-control custom-switch">
                             <input type="checkbox"
                                    class="custom-control-input chkMostrarIngredientes "
                                    id="<?php echo $uniqueId ?>">
                                  <label class="custom-control-label "
                                         for="<?php echo $uniqueId ?>">Flambeado Adicional (+ S/.2)</label>
                            </div>
                        <?php } ?>
                                                    ...
                                                    <?php foreach ($listaIngredientes as $ingrediente) {
                                                        ...
                                                        if ($ingrediente['idProducto'] == $campo['idProducto']) {
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="<?php echo $uniqueIdIng ?>"
                                                                       name="radioIngrediente"
                                                                       value="<?php echo $ingrediente['nombre'] ?>"
                                                                       class="custom-control-input">
                                                                <label class="custom-control-label"
                                                                       for="<?php echo $uniqueIdIng ?>"><?php echo $ingrediente['nombre'] ?></label>
                                                            </div>
                                                            <?php
                                                        }
                                                    } ?>
                        ...
                        <div class="text-center my-3" style="width: 100%;">
                            ...
                            <button
                                <?php echo ($campo['stock'] == 'NOT') ? 'disabled' : '' ?>
                                    class="btn btn-sm btn-danger btn-comprar" style="font-size:1.3rem;font-weight:bold"
                                    type="submit">

            ...
            <div class="col mb-5">
                <div class="card border-dark h-100 card-products">
                    ...
                    <div class="card-body p-2 d-flex flex-column">
                        <h4 class="card-title parrafoHelvetica text-center tituloProducto"
                        ><?php echo $campo['nombreProducto'] ?></h4>
                        <p class="card-text"><?php echo $campo['descripcionProducto'] ?></p>
                        <h4 class="text-center"><span
                                class="badge badge-dark">S/ <?php echo $campo['precioProducto'] ?>.00</span></h4>
                            ...
                            if ($campo['stock'] == 'YES') {
                                ...
                                if ($campo['productoObservaciones'] == 'GIFT_CARD') {
                                    ...
                                    <a data-toggle="modal"
                                       ...
                                       data-whatever="<?php echo $campo['idProducto'] ?>" href="#"
                                       class="btn btn-warning w-100 align-self-end mt-auto">Comprar <i class="fas fa-cart-plus"></i></a>
                                    <?php
                                } else {
                                    ?>
                                    <a onclick="mostrarLoading();"
                                       href="script/cartAction.php?action=addToCart&id=<?php echo $campo['idProducto'] ?>&cantidad=1"
                                       class="btn btn-warning w-100 align-self-end mt-auto">Comprar <i class="fas fa-cart-plus"></i></a>
                                    <?php
                                }
                    ...
                    <div class="row row-cols-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3  p-3 justify-content-center">
                        ...
                        <div class="col mb-2 mx-auto justify-content-center d-flex mt-2">
                            <div class="card h-100 card-products">
                                <div class="p-4">
                                    <img src="icon/electronico.png" class="card-img-top"
                                         alt="Billetera electrónica Senshi">
                        ...
                        <div class="col mb-2 mx-auto justify-content-center d-flex mt-2">
                            <div class="card h-100 card-products">
                                <div class="p-4">
                                    <img src="icon/regalo-de-navidad.png" class="card-img-top"
                                         alt="Gift Card Cevicheria Senshi">

...
$producto = $objProducto->getProductoById(370);
                                ...
                                <div class="col mx-3">
                                    <div class="row mb-2">
                                        <div class="col text-left px-0">
                                            <h6>Escoge 3 variedades de Maki</h6>
                                                                ...
                                                                <div class="col">
                                                                    <div class="input-group justify-content-center">
                                                                        <div class="input-group-prepend input-group-append">
                                                                            <button onclick="changeQtyMin0(this,'minus',0,3)" class="btn btn-light btn-sm" type="button">
                                                                            ...
                                                                            <button onclick="changeQtyMin0(this,'add',0,3)" type="button" class="btn btn-sm btn-light">
                                                    ...
                                                    ?>
                                                            <div class="row mt-2">
                                                                ...
                                                                <div class="col">
                                                                    <div class="input-group justify-content-center">
                                                                        <div class="input-group-prepend input-group-append">
                                                                            <button onclick="changeQtyMin0(this,'minus',0,3)" class="btn btn-sm btn-light" type="button">
                                                                                <i class="fas fa-minus"></i>
                                                                            </button>
                                                                            <input required onkeypress="return solonumeros(event);" type="number" readonly data-nombreIngrediente="<?php echo $ingrediente['nombre'] ?>" minlength="1" class="form-control text-center" min="0" name="cantidad" value="0" placeholder="Cantidad" aria-label="Cantidad" aria-describedby="button-addon2">
                                                                            <button onclick="changeQtyMin0(this,'add',0,3)" type="button" class="btn btn-sm btn-light">
    ...
    <script>
        $('#formComprar').submit(function(event) {
            ...
            if (totalSeleccionado !== 3) {
                Swal.fire(
                    'Puedes elegir como máximo 3 variedades de maki o 3 makis de una misma variedad',
                    '',
                    'error'
                );
                infoSeleccionados = '';

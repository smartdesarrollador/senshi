    ...
    <div class="container">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <div class="input-group justify-content-center">
                                                        <div class="input-group-prepend input-group-append">
                                                            <button onclick="changeQtyMin0(this,'minus',0,<?php echo $maxCantidadMakis ?>)" class="btn btn-light btn-sm" type="button">
                                                                <i class="fas fa-minus"></i>
                                                            </button>
                                                            <input style="width: 60px;" required onkeypress="return solonumeros(event);" type="number" readonly data-nombreIngrediente="<?php echo $ingrediente['nombre'] ?>" minlength="1" class="form-control text-center" min="0" name="cantidad" value="0" placeholder="Cantidad" aria-label="Cantidad" aria-describedby="button-addon2">
                                                            <button onclick="changeQtyMin0(this,'add',0,<?php echo $maxCantidadMakis ?>)" type="button" class="btn btn-sm btn-light">
        ...
        <div class="row jumbotron">
            <div class="col mx-3">
                <div class="row mb-2">
                    <div class="col text-left px-0">
                        <h6>Escoge <?php echo $cantidadSashimis ?> cortes de sashimi o 1 sashimi moriawase</h6>
                    </div>
                </div>
                                    ...
                                    ?>
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <div class="input-group justify-content-center">
                                                        <div class="input-group-prepend input-group-append">
                                                            <button onclick="changeQtyMin0(this,'minus',0,<?php echo $maxCantidadSashimis ?>)" class="btn btn-light btn-sm" type="button">
                                                                <i class="fas fa-minus"></i>
                                                            </button>
                                                            <input style="width: 60px;" required onkeypress="return solonumeros(event);" type="number" readonly data-nombreIngrediente="<?php echo $ingrediente['nombre'] ?>" minlength="1" class="form-control text-center" min="0" name="cantidad" value="0" placeholder="Cantidad" aria-label="Cantidad" aria-describedby="button-addon2">
                                                            <button onclick="changeQtyMin0(this,'add',0,<?php echo $maxCantidadSashimis ?>)" type="button" class="btn btn-sm btn-light">
                                                                <i class="fas fa-plus"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                ...
                                <div>
                                    <div class="input-group justify-content-center input-group-ingredientes">
                                        <div class="text-center">
                                            <input class="mt-2" style="transform: scale(1.5);" id="moriawaseSashimis" type="checkbox" aria-describedby="button-addon2">
        ...
        <div class="row jumbotron">
            <div class="col mx-3">
                <div class="row mb-2">
                    <div class="col text-left px-0">
                        <h6>Escoge <?php echo $cantidadSushis ?> cortes de sushi o 1 sushi moriawase</h6>
                    </div>
                </div>
                                    ...
                                    ?>
                                            <div class="row mt-2">
                                                <div class="col-6">
                                                    ...
                                                    <select onchange="addFlambeado2(this)" class="custom-select custom-select-sm bg-secondary text-white">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <div class="input-group justify-content-center">
                                                        <div class="input-group-prepend input-group-append">
                                                            <button onclick="changeQtyMin0(this,'minus',0,<?php echo $maxCantidadSushis ?>)" class="btn btn-light btn-sm" type="button">
                                                                <i class="fas fa-minus"></i>
                                                            </button>
                                                            <input style="width: 60px;" required onkeypress="return solonumeros(event);" type="number" readonly data-nombreIngrediente="<?php echo $ingrediente['nombre'] ?>" data-flambeado="" minlength="1" class="form-control text-center cantidadSushis" min="0" name="cantidad" value="0" placeholder="Cantidad" aria-label="Cantidad" aria-describedby="button-addon2">
                                                            <button onclick="changeQtyMin0(this,'add',0,<?php echo $maxCantidadSushis ?>)" type="button" class="btn btn-sm btn-light">
                                                                <i class="fas fa-plus"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    ?>
                                            <div class="row mt-2">
                                                ...
                                                <div class="col">
                                                    <div class="input-group justify-content-center">
                                                        <div class="input-group-prepend input-group-append">
                                                            <button onclick="changeQtyMin0(this,'minus',0,5)" class="btn btn-light btn-sm" type="button">
                                                                <i class="fas fa-minus"></i>
                                                            </button>
                                                            <input style="width: 60px;" required onkeypress="return solonumeros(event);" type="number" readonly data-nombreIngrediente="<?php echo $ingrediente['nombre'] ?>" minlength="1" class="form-control text-center" min="0" name="cantidad" value="0" placeholder="Cantidad" aria-label="Cantidad" aria-describedby="button-addon2">
                                                            <button onclick="changeQtyMin0(this,'add',0,5)" type="button" class="btn btn-sm btn-light">
                                                                <i class="fas fa-plus"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                        ...
                        <div class="card h-100 m-2 border-0 rounded">
                            <div class="card-body">
                                ...
                                <div>SUSHI MORIAWASE<br><small class="text-info">(A elección del
                                        itamae)</small></div>
                                <div>
                                    <div class="input-group justify-content-center input-group-ingredientes" style="">
                                        <div class="text-center">
                                            <input class="mt-2" style="transform: scale(1.5);" id="sushiMoriawase" type="checkbox" aria-describedby="button-addon2">
                ...
                <form action="script/cartAction.php" method="get" id="formComprar">
                    <div class="row mt-2">
                        <div class="col text-center">
                            ...
                            <input type="hidden" class="idProducto" name="id" value="<?php echo $producto['idProducto'] ?>">
                            ...
                            <div class="text-center">
                                ...
                                <div class="input-group mb-3 d-inline ">
                                    <div class="input-group-prepend input-group-append m-auto" style="width: 300px">
                                        ...
                                        <input required type="hidden" class="form-control text-center cantidad" name="cantidad" value="1" placeholder="Cantidad" aria-label="Cantidad" aria-describedby="button-addon2">
                                    </div>
                                </div>
                                <button <?php echo ($producto['stock'] == 'NOT') ? 'disabled' : '' ?> type="submit" class="btn btn-danger btn-primary  btn-comprar">COMPRAR
                                </button>
        ...
        $('#formComprar').submit(function(event) {
            ...
            if ($('#sushiMoriawase').prop("checked") == true) {
                ...
                if (totalSeleccionadoSushis !== cantidadSushis * 1) {
                    console.log(totalSeleccionadoSushis);
                    Swal.fire(

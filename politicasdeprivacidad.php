     ...
     <div class="container-fluid text-center" style="background:#000000;color:#ffffff;margin-top:130px">
	     <div class="row">
		      <div class="col-sm-12 col-xs-12"> 
               ...
               <h1 class="piqueos mt-1 ">POLITICAS DE PRIVACIDAD</h1>
				</div>
		  </div>
  	  </div>
...
<p class="text-justify mt-5">La presente Política de Privacidad establece los términos en que Senshi Sushi/Bar usa y protege la
...
<p class="text-justify">Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible,
...
<p class="text-justify">Senshi Sushi/Bar está altamente comprometido para cumplir con el compromiso de mantener su
información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos
que no exista ningún acceso no autorizado.</p>
<p><strong>Cookies</strong></p>
<p class="text-justify">Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para almacenarse
...
<p class="text-justify">Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su
...
<p class="text-justify">Senshi Sushi/Bar Se reserva el derecho de cambiar los términos de la presente Política de Privacidad

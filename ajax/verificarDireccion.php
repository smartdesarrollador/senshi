...
?>
    ...
    <script>
        ...
        var finalStoreLocal = 0;

        Culqi.options({
            style: {
                logo: 'https://senshi.pe/img/logo2.png',
                maincolor: '#000000',
                buttontext: '#ffffff',
                maintext: '#4A4A4A',
                desctext: '#4A4A4A'
                    ...
                    if (status === google.maps.GeocoderStatus.OK) {
                        ...
                        for (let i = 0; i < gMapsPolygons.length; i++) {
                            ...
                            if (google.maps.geometry.poly.containsLocation(results[0].geometry.location, gMapsPolygons[i].polygon)) {
                                ...
                                finalStoreLocal = gMapsPolygons[i].store;
                                finalShippingCost = gMapsPolygons[i].price;
                                console.warn(finalStoreLocal);
                                ...
                                if (finalStoreLocal == 2) {
                                    ...
                                    /* Publica Integracion Fumiko*/
                                    /* Culqi.publicKey = 'pk_test_5533d6f78dbbb7b2'; */


                                    /* Publica Produccion Fumiko*/
                                    Culqi.publicKey = 'pk_live_eef5c93e21246cc7';
                                }
...
<script>
    function culqi() {
        if (Culqi.token) { // ¡Objeto Token creado exitosamente!
            ...
            console.log('Se ha creado un token:' + token);
            /* console.log('se ha creado en numero store:' + finalStoreTienda); */
            ...
            datos.append('finalStoreLocal', finalStoreLocal);

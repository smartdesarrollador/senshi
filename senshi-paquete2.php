...
$producto = $objProducto->getProductoById(269);
$ingredientes = $objProductoIngrediente->getIngredientesByIdProducto(269);
?>
<!DOCTYPE html>
<html lang="eS">
...
<body>
                                ...
                                <div class="col mx-3">
                                    <div class="row mb-2">
                                        <div class="col text-left px-0">
                                            <h6>Escoge 4 variedades de Maki</h6>
                                                                ...
                                                                <div class="col">
                                                                    <div class="input-group justify-content-center">
                                                                        <div class="input-group-prepend input-group-append">
                                                                            <button onclick="changeQtyMin0(this,'minus',0,4)" class="btn btn-light btn-sm" type="button">
                                                                            ...
                                                                            <button onclick="changeQtyMin0(this,'add',0,4)" type="button" class="btn btn-sm btn-light">
                                                    ...
                                                    ?>
                                                            <div class="row mt-2">
                                                                ...
                                                                <div class="col">
                                                                    <div class="input-group justify-content-center">
                                                                        <div class="input-group-prepend input-group-append">
                                                                            <button onclick="changeQtyMin0(this,'minus',0,4)" class="btn btn-sm btn-light" type="button">
                                                                                <i class="fas fa-minus"></i>
                                                                            </button>
                                                                            <input required onkeypress="return solonumeros(event);" type="number" readonly data-nombreIngrediente="<?php echo $ingrediente['nombre'] ?>" minlength="1" class="form-control text-center" min="0" name="cantidad" value="0" placeholder="Cantidad" aria-label="Cantidad" aria-describedby="button-addon2">
                                                                            <button onclick="changeQtyMin0(this,'add',0,4)" type="button" class="btn btn-sm btn-light">
    ...
    <script>
        $('#formComprar').submit(function(event) {
            ...
            if (totalSeleccionado !== 4) {
                Swal.fire(
                    'Puedes elegir como máximo 4 variedades de maki o 4 makis de una misma variedad',
                    '',
                    'error'
                );
                infoSeleccionados = '';

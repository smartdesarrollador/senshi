...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        <div class="col text-center">
                            <button class="btn btn-danger btnRecojoEnTienda" onclick="cambiarmetodoDeEntrega(this)">Recojo
                                en tienda
                            </button>
                        </div>
                        <div class="col text-center">
                            <button class="btn btn-danger btnDelivery pl-5 pr-5" onclick="cambiarmetodoDeEntrega(this)">
                                Delivery
                            </button>
                        </div>
                    </div>
    ...
    <?php if ($_SESSION['contador_local'] == 'con_distrito') { ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <h3 class=" text-center">Selecciona Local de Recojo</h3>
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            ...
                            <div class="col-md-12 ">
                                <a href="sesion_zona_reparto_url.php?zona=san_borja&url=<?php echo $url; ?>" class="btn btn-danger btn-lg btn-block">Av. Aviación 3455 - San Borja</a><br>

                            </div>
                            <div class="col-md-12 ">
                                <a href="sesion_zona_reparto_url.php?zona=lince&url=<?php echo $url; ?>" class="btn btn-danger btn-lg btn-block">Julio C. Tello 885 - Lince</a><br>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#exampleModalcambio').modal('show')
        });
    </script>
    <script>
        $(document).ready(function() {
            $('#exampleModalLocal').modal('show')
        });
    </script>
    <script>
        $(document).ready(function() {

    ...
    <div class="row">
        ...
        foreach ($lista as $campo) {
            ...
            <form
                    ...
                    action="script/cartAction.php" method="get" class="col-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <p class="text-danger font-weight-bold">S/. <?php echo $campo['precioProducto'] ?>.00</p>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 col-xl-3 d-flex align-items-center justify-content-center">
                        <div class="text-center my-3">
                            ...
                            <?php if ($campo['productoObservaciones'] == 'MULTI_PAQUETE1') { ?>
                                <a href="senshi-paquete1.php" class="btn btn-danger btn-sm mt-2"
                                   style="font-weight:bold">
                                    Comprar
                                </a>
                            <?php } elseif ($campo['productoObservaciones'] == 'MULTI_PAQUETE2') { ?>
                                <a href="senshi-paquete2.php" class="btn btn-danger btn-sm mt-2"
                                   style="font-weight:bold">
                                    Comprar
                                </a>
                            <?php } elseif ($campo['productoObservaciones'] == 'MULTI_PAQUETE3') { ?>
                                <a href="senshi-paquete3.php" class="btn btn-danger btn-sm mt-2"
                                   style="font-weight:bold">
                                    Comprar
                                </a>
                            <?php } elseif ($campo['productoObservaciones'] == 'MULTI_PAQUETE4') { ?>
                                <a href="senshi-paquete4.php" class="btn btn-danger btn-sm mt-2"
                                   style="font-weight:bold">
                                    Comprar
                                </a>
                            <?php } elseif ($campo['productoObservaciones'] == 'MULTI_PAQUETE5') { ?>
                                <a href="senshi-paquete5.php" class="btn btn-danger btn-sm mt-2"
                                   style="font-weight:bold">
                                    Comprar
                                </a>
                            <?php }
                            elseif ($campo['productoObservaciones'] == 'MULTI_PAQUETE2-10082020') { ?>
                                <a href="paquete-2-1082020.php" class="btn btn-danger btn-sm mt-2"
                                   style="font-weight:bold">
                                    Comprar
                                </a>
                            <?php } ?>
                            <?php if ($campo['acumulaNPuntos'] > 0) { ?>
                                <small class="d-block text-danger">Acumula <?php echo $campo['acumulaNPuntos'] ?> puntos</small>
                            <?php } ?>
                        </div>
